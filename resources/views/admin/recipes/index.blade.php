<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.recipes.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none transition ease-in-out duration-150">
                + New Recipe
            </a>
        </div>
    </x-slot>
                ...
                <div class="p-4">
                    <form method="GET" class="flex flex-wrap gap-4 items-end">
                        <div>
                            ...
                            <x-text-input id="search" name="search" type="text" class="mt-1 block w-full" :value="request('search')" placeholder="Search recipes..." />
                        </div>
                        <div>
                        ...
                        @if(request('search') || request('category_id'))
                            <div>
                                <a href="{{ route('admin.recipes.index') }}" class="text-sm text-gray-600 hover:text-gray-900 underline">Clear filters</a>
                            </div>
                        @endif
                    </form>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($recipes as $recipe)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="text-xs text-gray-500">{{ $recipe->slug }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        <a href="{{ route('admin.recipes.edit', $recipe) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-gray-500">No recipes found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
