            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-1 order-2 lg:order-1">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-8">
                        ...
                        <!-- Add to Grocery List -->
                        <div class="mt-6">
                            <button class="w-full inline-flex items-center justify-center px-4 py-3 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors text-sm">
                            ...
                            <p class="text-xs text-gray-400 text-center mt-2">Coming in Sprint 3</p>
                        </div>
                    </div>
                </div>
