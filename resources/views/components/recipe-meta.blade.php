@props(['prep', 'cook', 'servings', 'difficulty'])

@if($prep)
    <span class="inline-flex items-center gap-1" title="Prep time">
        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
        {{ $prep }}m
    </span>
@endif
@if($cook)
    <span class="inline-flex items-center gap-1" title="Cook time">
...
@endif
<span class="inline-flex items-center gap-1" title="Servings">
